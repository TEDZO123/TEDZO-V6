...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/spirit.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        ...
        if (!!message.mention && message.mention[0] == '13607613051@s.whatsapp.net') {
