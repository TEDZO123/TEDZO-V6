...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'tedzo sᴇʀ' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+917736835721' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'ᴀslu sᴇʀ' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By tedzo Bᴏᴛ' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '0@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://telegra.ph/file/88594da3fe71f8699a9f0.jpg' : process.env.ALL_IMG,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'tedzö Sᴇʀ Bᴏᴛ🎗️/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '917736835721,0,919747075721,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
