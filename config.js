...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '♡         ❍ㅤ    ⎙ㅤ  ⌲ 
ˡᶦᵏᵉ  ᶜᵒᵐᵐᵉⁿᵗ  ˢᵃᵛᵉ  ˢʰᵃʳᵉ' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? '𝑻𝑬𝑫𝒁𝑶' : process.env.OWNER_NAME,
    ...
    BOT: process.env.BOT_NM === undefined ? '⊢‒‒‒ ⋈ ᴛᴇᴅᴢᴏsᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NM,
    KAZTRO_SER: process.env.KAZTRO_SER === undefined ? 'Happy' : process.env.KAZTRO_SER,
    KAZTRO_S: process.env.KAZTRO_S === undefined ? '⎚' : process.env.KAZTRO_S, 
